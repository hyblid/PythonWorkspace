...
btn_view = Button(frame_function_detail, text="VIEW",
                  width=15, height=2).grid(column=0, row=0)
btn_add = Button(frame_function_detail, text="ADD",
                 width=15, height=2).grid(column=1, row=0)
btn_delete = Button(
    frame_function_detail, text="DELETE", width=15, height=2, background="yellow").grid(column=2, row=0)
btn_modify = Button(frame_function_detail, text="MODIFY",
                    width=15, height=2).grid(column=0, row=1)
btn_edit = Button(frame_function_detail, text="EDIT",
                  width=15, height=2).grid(column=1, row=1)
btn_exit = Button(frame_function_detail, text="EXIT", width=15,
                  height=2, background="red").grid(column=2, row=1)
