...
from resources.stock_settings import *
...
class App(ctk.CTk):
    ...
    def create_graph(self, *args):
        ...
        if self.has_data:
            match self.time_string.get():
                ...
                case "Month" : data = self.one_months
    ...
    def input_handler(self, event=None):
        ...
        self.one_months = self.max.iloc[-22:]
...
class InputPanel(ctk.CTkFrame):
    def __init__(self, parent, input_string, time_string):
        ...
        #create one TextButton for every string inside of TIME_OPTIONS
...
class GraphPanel(ctk.CTkFrame):
        def __init__(self, parent, data):
            ...
            ax.yaxis.tick_right()
            #style the y axis so it looks better :direction, color, padding
