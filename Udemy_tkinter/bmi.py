...
class ResultText(ctk.CTkLabel):
    def __init__(self, parent, bmi_string):
        ...
        self.grid(column=0, row=0, rowspan=2, sticky="news",padx=10, pady=10)
...
class WeightInput(ctk.CTkFrame):
    def __init__(self, parent, weight_float, metric_bool):
        ...
        self.rowconfigure(0, weight=1, unifor = "b")
        self.columnconfigure(0, weight=2, unifor = "b")
        self.columnconfigure(1, weight=1, unifor = "b")
        self.columnconfigure(2, weight=3, unifor = "b")
        self.columnconfigure(3, weight=1, unifor = "b")
        self.columnconfigure(4, weight=2, unifor = "b")
        # text
        ...
        minus_button = ctk.CTkButton(self,command= lambda:self.update_weight(("minus","large")),text="-"
                                     , font = font, text_color=BLACK, fg_color=LIGHT_GRAY, hover_color=GRAY, corner_radius=BUTTON_CORNER_RADIUS )
...
class HeightInput(ctk.CTkFrame):
    def __init__(self,parent, height_int, metric_bool):
        ...
        out_text = ctk.CTkLabel(self, textvariable = self.output_string, text_color=BLACK, font=ctk.CTkFont(family=FONT, size= INPUT_FONT_SIZE)) 
        out_text.pack(side="left", padx=20)
