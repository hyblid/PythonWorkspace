...
MATH_POSITIONS = {
	'/': {'col': 3, 'row': 2, 'character':'', 'image path': {'light': 'C:\\test\\PythonWorkspace\\Udemy_tkinter\\resources\\divide_light.png', 'dark': "C:\\test\\PythonWorkspace\\Udemy_tkinter\\resources\\divide_light.png"}},
...
OPERATORS = {
	...
	'invert':  {'col': 1, 'row': 2, 'text': '', 'image path': {'light': "C:\\test\\PythonWorkspace\\Udemy_tkinter\\resources\\invert_light.png", 'dark': "C:\\test\\PythonWorkspace\\Udemy_tkinter\\resources\\invert_dark.png"}},
