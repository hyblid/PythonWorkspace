...
from resources.image_editor_setting import *
...
class FilePathPanel(Panel):
    ...
    #1.create a path_string variable in the expoert frame and pass it to this widget
    #2.add a button and an entry field
    ...
    #3.the button should open a fieldialog and the entry filed should display the returned path
...
class RevertButton(ctk.CTkButton):
    ...
    def revert(self):
        #when clicking on the button gtet the variables and set the value to the deafult
